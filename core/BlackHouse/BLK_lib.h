...
void* BLK_FUNC( Memory, debug_print    ) ( void*  ptr                , int   (*__print_func )(const char * RH_RESTRICT format, ...));
...
void* BLK_FUNC( Memory, cpyArea ) (void* RH_RESTRICT __dst,const void* RH_RESTRICT __src,size_t size,size_t nmenb_line,long xs,long ys,long xe,long ye);
void* BLK_FUNC( Memory, grbArea ) (void* RH_RESTRICT __dst,const void* RH_RESTRICT __src,size_t size,size_t nmenb_line,long xs,long ys,long xe,long ye);
